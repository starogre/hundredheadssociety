  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: const [
        ...
        SizedBox(height: 16),
        _PhaseHeader('Phase 1: Weekly Session System'),
        ...
        SizedBox(height: 16),
        _PhaseHeader('Phase 2: Awards & Social Features'),
        ...
        SizedBox(height: 16),
        _PhaseHeader('Phase 3: Visual Design Refresh'),
        ...
        SizedBox(height: 16),
        _PhaseHeader('Phase 4: iOS Compatibility'),
