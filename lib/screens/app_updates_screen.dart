  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: const [
        ...
        SizedBox(height: 16),
        _PhaseHeader('Phase 1: Awards & Social Features'),
        _RoadmapItem('Portrait milestone badges:'),
        _RoadmapBullet('5 portraits milestone'),
        _RoadmapBullet('10 portraits milestone'),
        _RoadmapBullet('25 portraits milestone'),
        _RoadmapBullet('50 portraits milestone'),
        _RoadmapBullet('100 portraits milestone'),
        _RoadmapItem('Instagram sharing integration:'),
        _RoadmapBullet('Share award-winning portraits to Instagram'),
        _RoadmapBullet('Share personal portraits to Instagram'),
        _RoadmapBullet('Custom sharing templates with app branding'),
        SizedBox(height: 16),
        _PhaseHeader('Phase 2: Visual Design Refresh'),
        ...
        SizedBox(height: 16),
        _PhaseHeader('Phase 3: iOS Compatibility'),
